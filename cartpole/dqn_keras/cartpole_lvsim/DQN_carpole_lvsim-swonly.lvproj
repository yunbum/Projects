...
<Project Type="Project" LVVersion="18008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="vi" Type="Folder">
			...
			<Item Name="Global_val.vi" Type="VI" URL="../vis/Global_val.vi"/>
			<Item Name="sub_angle-limit.vi" Type="VI" URL="../vis/sub_angle-limit.vi"/>
			<Item Name="sub_cmdbuf_fgv.vi" Type="VI" URL="../vis/sub_cmdbuf_fgv.vi"/>
			<Item Name="sub_cmdn_fgv.vi" Type="VI" URL="../vis/sub_cmdn_fgv.vi"/>
			<Item Name="sub_cmdparsing.vi" Type="VI" URL="../vis/sub_cmdparsing.vi"/>
			<Item Name="sub_ctrref_fgv.vi" Type="VI" URL="../vis/sub_ctrref_fgv.vi"/>
			<Item Name="sub_done_fgv.vi" Type="VI" URL="../vis/sub_done_fgv.vi"/>
			<Item Name="sub_dt.vi" Type="VI" URL="../vis/sub_dt.vi"/>
			<Item Name="sub_dt_fgv.vi" Type="VI" URL="../vis/sub_dt_fgv.vi"/>
			<Item Name="sub_loopcount.vi" Type="VI" URL="../vis/sub_loopcount.vi"/>
			<Item Name="sub_mr-timer.vi" Type="VI" URL="../vis/sub_mr-timer.vi"/>
			<Item Name="sub_setpos_fgv.vi" Type="VI" URL="../vis/sub_setpos_fgv.vi"/>
			<Item Name="sub_state-check_fgv.vi" Type="VI" URL="../vis/sub_state-check_fgv.vi"/>
			<Item Name="sub_state_fgv.vi" Type="VI" URL="../vis/sub_state_fgv.vi"/>
			<Item Name="sub_stop_fgv.vi" Type="VI" URL="../vis/sub_stop_fgv.vi"/>
			<Item Name="sub_tcp_fgv.vi" Type="VI" URL="../vis/sub_tcp_fgv.vi"/>
			<Item Name="sub_tcpbuf_fgv.vi" Type="VI" URL="../vis/sub_tcpbuf_fgv.vi"/>
			<Item Name="sub_updatepos_fgv.vi" Type="VI" URL="../vis/sub_updatepos_fgv.vi"/>
			<Item Name="test_check.vi" Type="VI" URL="../vis/test_check.vi"/>
			<Item Name="test_cmdbuf.vi" Type="VI" URL="../vis/test_cmdbuf.vi"/>
			<Item Name="test_dio.vi" Type="VI" URL="../vis/test_dio.vi"/>
			<Item Name="test_tcp.vi" Type="VI" URL="../vis/test_tcp.vi"/>
			<Item Name="test_tcpbuf.vi" Type="VI" URL="../vis/test_tcpbuf.vi"/>
			<Item Name="test_timer.vi" Type="VI" URL="../vis/test_timer.vi"/>
		...
		<Item Name="Dependencies" Type="Dependencies">
			...
			<Item Name="Cart Pendulum Model.vi" Type="VI" URL="../Model/Cart Pendulum Model.vi"/>
			<Item Name="Check Limits.vi" Type="VI" URL="../Model/Check Limits.vi"/>
			<Item Name="Control Main.vi" Type="VI" URL="../Control/Control Main.vi"/>
			<Item Name="Draw Linear Inverted Pendulum VRML.vi" Type="VI" URL="../vis/Draw Linear Inverted Pendulum VRML.vi"/>
			<Item Name="Draw Pendulum.vi" Type="VI" URL="../Model/Draw Pendulum.vi"/>
			<Item Name="Limit Motion Values.vi" Type="VI" URL="../Model/Limit Motion Values.vi"/>
			<Item Name="Limit PWM Value.vi" Type="VI" URL="../Model/Limit PWM Value.vi"/>
			<Item Name="Limit Theta Range.vi" Type="VI" URL="../Model/Limit Theta Range.vi"/>
			<Item Name="NiFpgaLv.dll" Type="Document" URL="NiFpgaLv.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="States.ctl" Type="VI" URL="../Model/States.ctl"/>
